...
Instance 1 (Home): Install Apache/Nginx. Create an index.html that says "Welcome to the Home Page".

Instance 2 (AWS): Install Apache/Nginx. Create an aws.html (or a folder /aws/index.html) that says "Welcome to the AWS App".

Instance 3 (Azure): Install Apache/Nginx. Create an azure.html (or /azure/index.html) that says "Welcome to the Azure App".

Instance 4 (GCP): Install Apache/Nginx. Create a gcp.html (or /gcp/index.html) that says "Welcome to the GCP App".
...
TG-Home: Register Instance 1. Health check path: /.

TG-AWS: Register Instance 2. Health check path: /aws (or /aws.html).

TG-Azure: Register Instance 3. Health check path: /azure (or /azure.html).

TG-GCP: Register Instance 4. Health check path: /gcp (or /gcp.html).

Phase 3: Create the Application Load Balancer (The Front Door)
Create an Internet-facing ALB.

Assign it to at least 2 Availability Zones (best practice).

Listeners: Create an HTTP:80 listener.

Default Action: Forward traffic to TG-Home. (This acts as your / catch-all).
